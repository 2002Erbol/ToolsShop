...
//                    break;
//                    case 2:
//                        Intent intent1= new Intent(getApplicationContext(),PerforatorCategoryActivity2.class);
...
//                }
                if(position==0){
                    ...
                    Intent intent= new Intent(getApplicationContext(),PerforatorCategoryActivity2.class);
                    startActivity(intent);
                }
                else{
